<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qlnv.aspx.cs" Inherits="Lab3_LTWeb_Bai2.qlnv" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="MaNhanVien" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Lab3DBConnectionString %>" DeleteCommand="DELETE FROM [qlnv] WHERE [MaNhanVien] = @MaNhanVien" InsertCommand="INSERT INTO [qlnv] ([TenNhanVien], [NgaySinh], [DiaChi], [DienThoai], [GioiTinh], [MaPhong]) VALUES (@TenNhanVien, @NgaySinh, @DiaChi, @DienThoai, @GioiTinh, @MaPhong)" SelectCommand="SELECT * FROM [qlnv]" UpdateCommand="UPDATE [qlnv] SET [TenNhanVien] = @TenNhanVien, [NgaySinh] = @NgaySinh, [DiaChi] = @DiaChi, [DienThoai] = @DienThoai, [GioiTinh] = @GioiTinh, [MaPhong] = @MaPhong WHERE [MaNhanVien] = @MaNhanVien">
                            <DeleteParameters>
